      ...
      <div className='bg-stroke relative h-1 w-full rounded-[8px] bg-custom-green-100'>
        <div
          className={classNames(
            ...
            'absolute bottom-full top-[-30px] -ml-8 h-5 font-scandia text-xs font-medium leading-5 text-custom-gray-100 transition-all duration-[900ms] ease-out',
          )}
          style={{
        ...
        <div
          className='absolute left-0 top-0 h-full rounded-[8px] bg-custom-brand-color-green transition-all duration-[900ms] ease-out'
